...
echo "安装下载好的包: (可选)..." | tee -a /home/immortalwrt-auto/log.txt
...
cp -rf /home/immortalwrt/23.05.2/config/config_generate /home/immortalwrt/package/base-files/files/bin/
